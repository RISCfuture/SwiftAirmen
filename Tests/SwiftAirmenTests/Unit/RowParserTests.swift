    ...
    func medicalWithoutDate(medClass: String) throws {
        ...
        #expect {
            ...
            guard let airmenError = error as? Errors,
                  case .medicalWithoutDate(uniqueID: "A0000003") = airmenError else {
                return false
            }
            return true
        }
...
struct PilotCertRowParserTests {
    ...
    func combinedInstrumentRatings() throws {
        ...
        if let cert = airman.certificates.first,
           case let .pilot(_, ratings, _) = cert {
    ...
    func pilotCertWithoutLevel() throws {
        ...
        #expect {
            ...
            guard let airmenError = error as? Errors,
                  case .levelNotGiven(uniqueID: "A0000004") = airmenError else {
                return false
            }
            return true
        }
    ...
    func cfiWithoutExpiration() throws {
        ...
        #expect {
            ...
            guard let airmenError = error as? Errors,
                  case .expirationDateNotGiven(uniqueID: "A0000006") = airmenError else {
                return false
            }
            return true
        }
...
struct NonPilotCertRowParserTests {
    ...
    func repairmanLightSport() throws {
        ...
        if let cert = airman.certificates.first,
           case let .repairmanLightSport(ratings) = cert {
    ...
    func riggerWithoutLevel() throws {
        ...
        #expect {
            ...
            guard let airmenError = error as? Errors,
                  case .levelNotGiven(uniqueID: "A0000005") = airmenError else {
                return false
            }
            return true
        }
